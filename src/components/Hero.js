      ...
      <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
        ...
        <div class="text-center lg:w-2/3 w-full max-w-7xl">
          ...
          <div class="flex justify-center">
            ...
            <button class="myFont5 button2 inline-flex text-white bg-indigo-500 border-0 py-2 px-6 items-center focus:outline-none roundeds text-base mt-4 md:mt-0">
              Get Started
            </button>
            <button class="myFont5 ml-4 button2 inline-flex items-center focus:outline-none roundeds text-base mt-4 md:mt-0">
              Check Steps
            </button>
          </div>
        </div>
